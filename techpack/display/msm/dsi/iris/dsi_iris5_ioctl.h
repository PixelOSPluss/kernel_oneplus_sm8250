...
#ifndef DRM_IOCTL_MSM_IRIS_OPERATE_CONF
#define DRM_IOCTL_MSM_IRIS_OPERATE_CONF DRM_IOWR(DRM_COMMAND_BASE + DRM_MSM_IRIS_OPERATE_CONF, struct msm_iris_operate_value)
#define DRM_IOCTL_MSM_IRIS_OPERATE_TOOL DRM_IOWR(DRM_COMMAND_BASE + DRM_MSM_IRIS_OPERATE_TOOL, struct msm_iris_operate_value)
#endif
